    ...
    >
      <Defs>
        <Mask id="heartMask">
          ...
          {filled && (
            <Path 
              d="M20.5833 7.58327C21.872 7.58327 22.9166 8.62794 22.9166 9.9166" 
              stroke="black" 
              strokeWidth="3"
              fill="none"
            />
      ...
      {/* Heart shape - filled when active with transparent curved inner line, outline when inactive */}
      <Path
        ...
        mask={filled ? "url(#heartMask)" : "none"}
      />
    </Svg>
  );
};
