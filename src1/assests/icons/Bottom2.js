    ...
    >
      <Defs>
        <Mask id="coursesMask">
          ...
          {filled && (
            <>
              <Rect x="6.58333" y="10.6667" width="9.33337" height="1" fill="black" />
              <Rect x="6.58333" y="15.3334" width="9.33337" height="1" fill="black" />
              <Rect x="6.58333" y="20" width="4.66667" height="1" fill="black" />
            </>
          )}
        </Mask>
      </Defs>
      
      {/* Document shape - filled when active */}
      <Path
        ...
        mask={filled ? "url(#coursesMask)" : "none"}
      />
      
      {/* All lines - only when not filled */}
      {!filled && (
        <>
          <Path
            d="M6.58333 10.6667H15.9167"
            stroke={color}
            strokeWidth={1.5}
            strokeLinecap="round"
            fill="none"
